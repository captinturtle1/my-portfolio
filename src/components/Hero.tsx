    ...
    <div className='w-screen h-screen min-h-[1000px] flex bg-red-400 text-white'>
      <div className='m-auto flex flex-col lg:flex-row gap-16'>
        ...
        <div className='flex flex-col gap-5 my-auto'>
          ...
          <div className='text-lg text-center lg:text-left max-w-[500px] p-10 lg:p-0'>Hi, I am Austin. I am a full-stack developer, mostly front-end. I primarily use NextJS and Tailwind for my projects. This is my portfolio website.</div>
